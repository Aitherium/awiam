...
interesting failures live BETWEEN them. "awiam is installed" is not the useful
fact -- "awiam is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awiam'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['awbac', 'awdit']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awiam needs at runtime, and a
